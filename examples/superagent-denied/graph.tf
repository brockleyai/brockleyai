# E2E Superagent Denied Tools
#
# Terraform representation of the E2E Superagent Denied Tools test graph.
# See graph.json for the equivalent JSON representation.

variable "name" {
  type    = string
  default = "E2E Superagent Denied Tools"
}
...
resource "brockley_graph" "test" {
  ...
  [
    ...
    },
    {
      ...
      "config": {
        "prompt": "Reply with exactly: hello from denied",
        "provider": "openrouter",
