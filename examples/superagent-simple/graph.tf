# E2E Superagent Simple
#
# Terraform representation of the E2E Superagent Simple test graph.
# See graph.json for the equivalent JSON representation.

variable "name" {
  type    = string
  default = "E2E Superagent Simple"
}
...
resource "brockley_graph" "test" {
  ...
  [
    ...
    },
    {
      ...
      "config": {
        "prompt": "Reply with exactly: hello from simple",
        "provider": "openrouter",
